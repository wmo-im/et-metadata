# ![World Meteorological Organization](https://community.wmo.int/themes/custom/wmo/logo.png) WMO Expert Team on Metadata Standards (ET-Metadata)
...
|Name | Affiliation/Country | GitHub handle |
|---|---|---|
